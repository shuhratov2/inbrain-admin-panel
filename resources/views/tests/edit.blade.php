...
@section('title', 'Test ozgartirish')
...
<div class="card">
  ...
  <div class="card-body">
    ...
    <form action="{{ url('admin_panel/test/' .$tests->id) }}" method="post">
      {!! csrf_field() !!}
      @method("PATCH")
      <label>Kurs</label></br>
      ...
      <div class="row justify-content-center">
        <div class="">
        <input class="form-check-input" onclick="variantd()" name="" type="checkbox" value="" id="variant_d">
